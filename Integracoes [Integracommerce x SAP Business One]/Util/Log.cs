    ...
    public class Log
    {
        ...
        public void WriteLogTable(SAPbobsCOM.Company company, string tipoDocumento, string numVtex, string numSAP, string status, string mensagem)
        {
            try
            {
                ...
                {
                    SAPbobsCOM.UserTable userTableLog = (SAPbobsCOM.UserTable)company.UserTables.Item("LOG_INTEGRACOMMERCE");
                    ...
                    userTableLog.UserFields.Fields.Item("U_numIntegracommerce").Value = numVtex;
